...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .card {
      background: white; border-radius: 12px; padding: 2rem 2rem 1.75rem;
      width: 100%; max-width: 360px;
      box-shadow: 0 4px 24px rgba(0,0,0,.08);
      text-align: center;
    }
    ...
    .subtitle { margin: 0 0 1.5rem; color: #666; font-size: .875rem; line-height: 1.5; }
    .btn {
    ...
    .hint { margin-top: 1rem; font-size: .75rem; color: #aaa; }
  </style>
</head>
<body>
  <div class="card">
    ...
    <p class="hint">Window didn't close? You can safely close this tab manually.</p>
  </div>
