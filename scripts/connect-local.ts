...
async function main() {
  ...
  console.log(`  ${c.dim("2.")} Run ${c.cyan("ngrok http 8787")} in another → copy the ${c.cyan("https://")} URL`);
  console.log(`  ${c.dim("3.")} Add ${c.cyan("<ngrok-url>/mcp")} as a custom connector at ${c.cyan(CONNECTORS_URL)}`);
  console.log();
}
